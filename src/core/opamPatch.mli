...
(** [patch CONF ~allow_unclean ?patch_filename ~dir diffs] applies a
    patch to given element by [CONF].

    @param CONF is a module that defines the element that we are patching and
