...
## opam-core
  ...
  * ` OpamSystem`: add `is_archive_from_string` that does the same than `is_archove` but without looking at the file, only analysing the string (extension) [#6219 @rjbou]
