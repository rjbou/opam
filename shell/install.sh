...
bin_sha512() {
  case "$OPAM_BIN" in
    opam-2.0.0-amd64-openbsd)   echo "XXX TO FILL";;
    opam-2.0.0-arm64-linux)     echo "XXX TO FILL";;
    opam-2.0.0-armhf-linux)     echo "XXX TO FILL";;
    opam-2.0.0-i686-linux)      echo "XXX TO FILL";;
    opam-2.0.0-x86_64-darwin)   echo "XXX TO FILL";;
    opam-2.0.0-x86_64-linux)    echo "XXX TO FILL";;
    *) echo "no sha";;
  esac
}
